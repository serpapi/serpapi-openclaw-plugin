...
export function createSerpApiTrendsTool(api: OpenClawPluginApi, ctx?: SerpApiToolCtx): AnyAgentTool {
  return {
    name: "serpapi_trends",
    ...
    parameters: {
      ...
      properties: {
        query: {
          type: "string",
          description: 'Search term(s). Up to 5 comma-separated for TIMESERIES/GEO_MAP (e.g. "coffee,tea,juice").',
        },
        ...
        gprop: {
          ...
          description: "Property filter: images, news, froogle=Shopping, youtube. Omit for Web (default).",
        },
        tz: {
          type: "number",
