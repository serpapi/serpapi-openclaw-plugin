...
export function createSerpApiEventsTool(api: OpenClawPluginApi, ctx?: SerpApiToolCtx): AnyAgentTool {
  return {
    name: "serpapi_events",
    ...
    parameters: {
      ...
      properties: {
        ...
        htichips: {
          type: "string",
          description: "Date filter: date:today, date:tomorrow, date:week, date:weekend, date:next_week, date:month.",
        },
